---
type: Concept
title: Prompt and handoff artifacts
description: Prompt-ready operational handoffs are a recurring Homestead artifact style.
domain: homesteadai-io
status: canonical
confidence: high
source_refs: [/_raw/homesteadai-io/claude-corpus-2026-06-25/prompt-and-handoff-artifacts-evidence.json]
...
Prompt-ready operational handoffs are a recurring Homestead artifact style.

## Durability

- Reconciled source count: 93
- Confidence: high
- Repetition is treated as signal; this concept collapsed repeated chat/doc evidence into one file.

## Evidence

- `chat:44bc4bee-effa-4fa3-b828-e97c7e47133b` (chat, 178 msgs): Phase 10 Onboarding — ity infrastructure" became "Lyhna is the binding authority infrastructure." The naming convention for distribution surfaces was locked: `@lyhna/bind` (core), `@lyhna/gate` (middleware/runtime enforcement), `@lyhna/cli` (operator surface). The positioning sentence became: "Lyhna runs wherever execution happens." Adam explicitly rejected time-based estimates for build tasks, preferring complexity ratings (Easy/Medium/Difficult or Claude Code straight-through vs. human loops required). Adam also...
...
- Redacted evidence bundle: [/_raw/homesteadai-io/claude-corpus-2026-06-25/prompt-and-handoff-artifacts-evidence.json](/_raw/homesteadai-io/claude-corpus-2026-06-25/prompt-and-handoff-artifacts-evidence.json)
